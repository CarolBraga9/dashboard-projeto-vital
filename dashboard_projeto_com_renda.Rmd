...
# --- ABORDAGEM DE INSTALAÇÃO DIRETA E CORRIGIDA ---
...
# Itera sobre os pacotes e instala apenas os que não estão presentes
for (pacote in pacotes_necessarios) {
  if (!require(pacote, character.only = TRUE)) {
    # CORREÇÃO CRÍTICA: A URL do repositório agora é uma string de texto válida.
