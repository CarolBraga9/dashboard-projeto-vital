...
if (!require("flexdashboard")) install.packages("flexdashboard", repos = "https://cloud.r-project.org")
if (!require("shiny")) install.packages("shiny", repos = "https://cloud.r-project.org")
if (!require("shinyjs")) install.packages("shinyjs", repos = "https://cloud.r-project.org")
...
if (!require("geobr")) install.packages("geobr", repos = "https://cloud.r-project.org")
...
if (!require("timevis")) install.packages("timevis", repos = "https://cloud.r-project.org")
