...
# Este bloco garante que todos os pacotes necessários sejam instalados
# no ambiente de execução, como o do GitHub Actions.
...
if(length(pacotes_a_instalar) > 0) {
  # CORREÇÃO: Removida a formatação de Markdown da URL do repositório.
  install.packages(pacotes_a_instalar, repos = "[http://cran.us.r-project.org](http://cran.us.r-project.org)")
}
...
# CORREÇÃO: Removida a formatação de Markdown da URL da planilha.
