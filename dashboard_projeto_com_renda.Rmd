...
# CORREÇÃO FINAL: As URLs agora são strings de texto simples, permitindo a instalação.
...
# CORREÇÃO FINAL: A URL é uma string de texto simples, sem formatação Markdown.
