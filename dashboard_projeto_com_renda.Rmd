...
# Nenhuma lógica Shiny (reativa) deve estar aqui.
# ===================================================================
...
```{r shiny-reactives, include=FALSE}
# ===================================================================
# CHUNK DE SETUP REATIVO
# Toda a lógica Shiny (observers, reactives, renderUI, etc.) foi
# movida para este chunk separado para garantir a ordem de execução correta.
# ===================================================================
...
<!--
  Este chunk agora será executado DEPOIS dos chunks de setup,
  e a função uiOutput() será encontrada sem problemas.
-->
```{r, echo=FALSE}
