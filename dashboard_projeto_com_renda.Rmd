...
# --- ABORDAGEM DE INSTALAÇÃO FINAL E DIRETA ---
# CORREÇÃO DEFINITIVA: A URL do repositório está agora como uma string de texto simples,
# que é o formato correto para o R. A lógica complexa foi removida
# para garantir que a instalação seja executada sem falhas no GitHub Actions.
...
# Instala todos os pacotes diretamente. Em um ambiente limpo como o do GitHub,
# esta é a forma mais robusta.
install.packages(pacotes_necessarios, repos = "[https://cloud.r-project.org](https://cloud.r-project.org)")

# --- CARREGAMENTO DAS BIBLIOTECAS ---
# Garante que todas as bibliotecas sejam carregadas após a instalação
...
# CORREÇÃO DEFINITIVA: A URL da planilha agora é uma string de texto válida.
