...
# --- ABORDAGEM DE INSTALAÇÃO ROBUSTA DE PACOTES ---
# Esta nova abordagem garante que o pacote 'remotes' esteja instalado
# e o utiliza para instalar os demais pacotes necessários a partir do CRAN.
# É um método mais confiável para ambientes automatizados como o GitHub Actions.
if (!require("remotes")) {
...
# Usando remotes para instalar todos os pacotes necessários de uma vez
remotes::install_cran(pacotes_necessarios, repos = "[https://cloud.r-project.org](https://cloud.r-project.org)")

# --- CARREGAMENTO DAS BIBLIOTECAS ---
# O carregamento é feito após a garantia da instalação
...
# CORREÇÃO DEFINITIVA: A URL é uma string de texto simples, sem formatação Markdown.
